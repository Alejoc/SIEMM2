...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO psico_ce_sm ( id_adm_hosp, id_user, freg_psicoce_sm, hreg_psicoce_sm,m_consulta,h_personal_familiar,evaluacion_psicologica,analisis_caso,recomendaciones,estado_psicoce_sm) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["motivo_consulta"]."','".$_POST["hpersonal_familiar"]."','".$_POST["evaluacion_psico"]."','".$_POST["analisis_caso"]."','".$_POST["recomendaciones"]."','Realizada')";
...
<table class="table table-bordered">
	<tr>
		...
		<th id="th-estilo4">Valoracion Psicologia</th>
