...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="20mm">
    ...
    <page_footer> <!-- Define el footer de la hoja -->
        ...
        <tr class="fila">
			  <td>
					<i>Instituto de reahabilitacion y habilitacion infantil Emmanuel IPS - www.emmanuelips.com </i>
				</td>
				</tr>
        </table>
    </page_footer>
			...
			<td >
				<table id="datos">
					<tr class="fila">
						...
						<td style="width:70%">
							<?php echo $datos[0]["nom1"]. ' '. $datos[0]["nom2"] . ' '.$datos[0]["ape1"]. ' '.$datos[0]["ape2"];?>
						</td>
					</tr>
					<tr class="fila">
						<td style="width:30%">
