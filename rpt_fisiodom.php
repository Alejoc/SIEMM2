...
e.id_evofisio_dom id, e.freg_evofisio_dom fecha_evo,e.hreg_evofisio_dom hora_evo,e.hfin_evofisio_dom hora_fin,e.evolucionfisio_dom evolucion,e.id_user id_user,
...
where b.tipo_servicio = 'Domiciliarios' and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evofisio_dom BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
