...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'E':
			$sql="UPDATE adm_hospitalario a INNER JOIN traslados t on a.id_adm_hosp=t.id_adm_hosp SET t.fprog_recibido='".$_POST["fprog"]."', t.hprog_recibido='".$_POST["hprog"]."', t.destino='".$_POST["sedes"]."',t.obs_recibido='".$_POST["obs_recibido"]."', t.estado_traslado='Completado', t.resp_recibido='".$_SESSION["AUT"]["nombre"]."', a.id_sedes_ips='".$_POST["sedes"]."' where a.id_adm_hosp='".$_POST["idadmhosp"]."' and t.id_traslado='".$_POST["id"]."'";
		...
		//echo $sql;
		if ($bd1->consulta($sql)){
			$subtitulo="Solicitud de traslado $subtitulo con exito!";
			$check='si';
		}else{
			$subtitulo="Solicitud de traslado NO fue $subtitulo !!! .";
			$check='no';
		}
