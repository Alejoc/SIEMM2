...
'Realizada')";
				...
				$subtitulo2="Medicina General";
			break;
			case 'EVO':
			$horaInicial=$_POST["hregevo"];
			$horat= strtotime ( '+40 minute' , strtotime ( $horaInicial ) ) ;
			$ht=date('H:i',$horat);
				$sql="INSERT INTO evo_fisio_dom ( id_adm_hosp, id_user,freg_evofisio_dom, hreg_evofisio_dom, hreg_regfisio_dom, hfin_evofisio_dom, evolucionfisio_dom, estado_evofisio_dom) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hregevo"]."','".$_POST["hreg"]."','$ht','".$_POST["evoto"]."','Realizada')";
				$subtitulo="Evolucion";
				$subtitulo1="Adicionado";
				$subtitulo2="Medicina General";
			break;
...
if (isset($_GET["mante"])){					///nivel 2
    ...
    where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/valinimed_dom.php';
			$subtitulo='Valoracion inicial Medicina General';
			break;
			case 'EVO':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
      ...
      where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/controlmed_dom5.php';
			$subtitulo='Valoracion por control Medicina general';
			break;
			case 'IM':
      $sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
      b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
...
<table class="table table-bordered">
	<tr>
		...
		<th id="th-estilo4">Valoracion de control</th>
