...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["tipo_hc"]."', '".$_POST["motivo_consulta"]."', '".$_POST["enfer_actual"]."', '".$_POST["antalergico"]."', '".$_POST["antpatologico"]."', '".$_POST["antquirurgico"]."', '".$_POST["anttoxicologico"]."', '".$_POST["antfarmacologico"]."', '".$_POST["antineco"]."', '".$_POST["antpsiquiatrico"]."', '".$_POST["anthospitalario"]."', '".$_POST["anttrauma"]."', '".$_POST["antfami"]."', '".$_POST["antotros"]."','".$_POST["tas"]."', '".$_POST["tad"]."', '".$_POST["fc"]."', '".$_POST["fr"]."', '".$_POST["so2"]."', '".$_POST["peso"]."', '".$_POST["talla"]."', '".$_POST["glasgow"]."', '".$_POST["gucometria"]."', '$imc', '".$_POST["rxs"]."', '".$_POST["cabcuello"]."', '".$_POST["torax"]."', '".$_POST["ext"]."', '".$_POST["abdomen"]."', '".$_POST["neurologico"]."', '".$_POST["genitourinario"]."', '".$_POST["barthel"]."', '".$_POST["weefim"]."', '".$_POST["cruzroja"]."', '".$_POST["raisberg"]."', '".$_POST["karnell"]."', '".$_POST["grossmotor"]."', '".$_POST["norton"]."', '".$_POST["honenyahr"]."', '".$_POST["analisis"]."', '".$_POST["finalidad"]."', '".$_POST["causa_externa"]."', '".$_POST["dx"]."', '".$_POST["tdx"]."', '".$_POST["dx1"]."', '".$_POST["tdx1"]."', '".$_POST["dx2"]."', '".$_POST["tdx2"]."', '".$_POST["dx3"]."', '".$_POST["tdx3"]."', '".$_POST["plant"]."','Realizada')";
