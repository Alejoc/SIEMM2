...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'VI':
				$sql="INSERT INTO tshd_sm ( id_adm_hosp, id_user, freg_tsce_sm, hreg_tsce_sm,tipo_atencion,h_familiar,estudio_socio,analisis,concepto_ts,recomendaciones,estado_tsce_sm) VALUES
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_tshd_sm (id_evohd, id_adm_hosp, id_user, freg_evohd, hreg_evohd, evolucion_hd, estado_evohd, resp_evohd) VALUES
