...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			('".$_POST["ideps"]."','".$_POST["idpaci"]."','".$_POST["sedes"]."','".$_POST["fingreso"]."','".$_POST["hingreso"]."','".$_POST["tusuario"]."','".$_POST["tafiliacion"]."','".$_POST["ocupacion"]."','".$_POST["dep"]."','".$_POST["mun"]."','".$_POST["zona"]."','".$_POST["nivel"]."','".$_POST["viaingreso"]."','".$_POST["tservicio"]."','".$_SESSION["AUT"]["nombre"]."','".$_POST["estadoadmhosp"]."')";
