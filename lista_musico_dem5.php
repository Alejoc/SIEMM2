...
<table class="table table-bordered">
	...
	if ($tabla=$bd1->sub_tuplas($sql)){
		...
		foreach ($tabla as $fila ) {
			...
			echo'<th class="text-center"><a href="'.PROGRAMA.'?opcion=132&return=117&idadmhosp='.$fila["id_adm_hosp"].'"><button type="button" class="btn btn-success sombra_movil" ><span class="fa fa-plus-circle"></span></button></a></th>';
			echo "</tr>\n";
		}
	}
