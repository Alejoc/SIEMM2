...
'".$_POST["obs_istactil"]."'	,'Realizada'
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_equino_reh (id_adm_hosp, id_user, freg_evoequino_reh, hreg_evoequino_reh, evolucionequino_reh, estado_evoequino_reh) VALUES
				('".$_POST["idadmhosp"]."','".$_SESSION["AUT"]["id_user"]."','".$_POST["freg"]."','".$_POST["hreg"]."','".$_POST["evoto"]."','Realizada')";
				$subtitulo="Evolución";
				$subtitulo1="Adicionado";
				$subtitulo2="Equinoterapia";
			break;
			case 'IM':
				$sql="INSERT INTO im_equino_reh ( id_adm_hosp, id_user, freg_imequino_reh, hreg_imequino_reh, objetivo_imequino_reh, actrealizada_imequino_reh, logros_imequino_reh, plant_imequino_reh, estado_imequino_reh) VALUES
			...
			break;
			case 'PT':
				$sql="INSERT INTO plantrimestral_equino_reh( id_adm_hosp, id_user, freg_ptequino_reh, hreg_ptequino_reh, obgen_equino_reh, obespec1_equino_reh, obespec2_equino_reh, obespec3_equino_reh, estado_ptequino_reh) VALUES
...
if (isset($_GET["mante"])){					///nivel 2
	switch ($_GET["mante"]) {
		...
		where b.id_adm_hosp ='".$_GET["idadmhosp"]."'" ;
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/evo_equino_reh5.php';
			$subtitulo='Evolución Diaria  Equinoterapia';
			break;
			case 'IM':
			$sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
			b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/imequino_reh5.php';
			$subtitulo='Informe Mensual  Equinoterapia';
			break;
			case 'PT':
			$sql="SELECT a.tdoc_pac,a.doc_pac,nom1,nom2,ape1,ape2,edad,fnacimiento,dir_pac,tel_pac,rh,email_pac,genero,lateralidad,religion,fotopac,
			b.id_adm_hosp,fingreso_hosp,hingreso_hosp,fegreso_hosp,hegreso_hosp,
			...
			$date=date('Y-m-d');
			$date1=date('H:i');
			$form1='formularios/planequino_reh.php';
			$subtitulo='Plan Trimestral Equinoterapia';
			break;
