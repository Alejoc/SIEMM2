...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			break;
			case 'EVO':
				$sql="INSERT INTO evo_psiqui_inde (id_adm_hosp, id_user, freg_evo_psiqui, hreg_evo_psiqui, objetivo_psiqui, subjetivo_psiqui, analisis_evo_psiqui, plan_tratamiento_psiqui, dxp, tdxp, dx1, tdx1, dx2, tdx2, servicio, estado_evo_psiqui) VALUES
...
<section class="panel-heading"><h4>Programa AVD Especialidad Psiquiatria</h4></section>
