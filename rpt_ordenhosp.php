...
class MYPDF extends TCPDF {
	...
	public function ColoredTable($header,$data) {
      ...
      $this->SetFont('helvetica', '',8);
      $this->Cell(25,0, utf8_encode($row['ts_ord_med_hosp']),1,0,'C');
      $this->SetFont('helvetica', 'B',8);
...
from pacientes a inner join adm_hospitalario b on a.id_paciente=b.id_paciente
      ...
      left join ord_med_hosp k on (k.id_adm_hosp=b.id_adm_hosp)
      left join user l on (l.id_user=k.id_user)

where b.id_adm_hosp ='".$_GET["idadmhosp"]."' and k.id_ord_med_hosp ='".$_GET["idordhosp"]."' ";
//echo $sql;
$rs = mysql_query($sql);
