...
e.id_evoto_dom id, e.freg_evoto_dom fecha_evo,e.hreg_evoto_dom hora_evo,e.hfin_evoto_dom hora_fin,e.evolucionto_dom evolucion,e.id_user id_user,
...
where b.tipo_servicio = 'Domiciliarios' and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evoto_dom BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
