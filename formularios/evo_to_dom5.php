<form action="<?php echo PROGRAMA.'?&opcion=64';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()" role="form" class="form-horizontal">
	...
	<article>
		<h4 id="th-estilot">Evoluciones Terapia Ocupacional Domiciliarios</h4>
