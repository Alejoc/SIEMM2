...
e.id_evotr_dom id, e.freg_evotr_dom fecha_evo,e.hreg_evotr_dom hora_evo,e.hfin_evotr_dom hora_fin,e.evoluciontr_dom evolucion,e.id_user id_user,
...
where b.tipo_servicio = 'Domiciliarios' and b.id_adm_hosp ='".$_GET["idadmhosp"]."' and e.freg_evotr_dom BETWEEN '".$_GET["f1"]."' and '".$_GET["f2"]."'
order by 9 ASC
";
//echo $sql;
$rs = mysql_query($sql);
