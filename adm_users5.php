...
$subtitulo="";
	if(isset($_POST["operacion"])){	//nivel3
		if($_POST["aceptar"]!="Descartar"){
			...
			case 'E':
				$sql="UPDATE user SET nombre='".$_POST["nombre"]."',cuenta='".$_POST["cuenta"]."',id_perfil='".$_POST["id_perfil"]."',especialidad='".$_POST["especialidad"]."',estado='".$_POST["estado"]."'$fotoE$claveE$firmaE WHERE id_user=".$_POST["idu"];
...
<form action="<?php echo PROGRAMA.'?&opcion=1';?>" method="POST" enctype="multipart/form-data" onsubmit="return validar()">
  <section class="panel panel-default">
	...
	<section class="panel panel-body text-center">
		...
		<article class="col-xs-3">
			<label class="text-center">Registro Profesional:</label><br>
			<input type="text" class="form-control text-center" name="rm_profesional" value="<?php echo $fila["rm_profesional"];?>"<?php echo $atributo2;?>/>
		</article>
		...
		<article class="col-xs-5">
			<label>Firma:</label>
			Archivo: <?php echo $fila["firma"];?><br>
...
$nom=$_REQUEST["nom"];
$sql="SELECT id_user,nombre,cuenta,foto,estado,nombre_perfil FROM user u LEFT JOIN perfil p ON u.id_perfil=p.id_perfil where nombre like '%".$nom."%'";
