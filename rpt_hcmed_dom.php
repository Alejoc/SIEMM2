...
i.descripuedad,
j.nom_eps,
k.id_hchosp,freg_hchosp, hreg_hchosp, tipo_hc, motivo_consulta, enfer_actual, ant_alergicos, ant_patologico, ant_quirurgico, ant_toxicologico, ant_farmaco, ant_gineco, ant_psiquiatrico, ant_hospitalario, ant_traumatologico, ant_familiar, otros_ant, tas, tad, fc, fr, so2, peso, talla, glasgow, gucometria, imc, rxs, cabcuello, torax, ext, abdomen, neurologico, genitourinario, barthel, weefim, cruzroja, raisberg, karnell, grossmotor, norton, honenyahr,fac, analisis, finalidad, causa_externa, dxp, tdxp, dx1, tdx1, dx2, tdx2, dx3, tdx3, plan_manejo,
